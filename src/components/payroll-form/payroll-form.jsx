...
const PayrollForm = (props) => {
  ...
  const onChangeName = (event) => {
    ...
    if (
      ...
      formValue.error.name = "Name must start with capital letter and be of atleast 3 letters";
  ...
  const onChangeYear = (event) => {
    ...
    if (inputDate > Date.now())
      formValue.error.startDate = "Sorry, You moved to future";
  ...
  const validData = async () => {
    ...
    if (
      ...
      error.name = "Name must start with capital letter and be of atleast 3 letters";
      isError = true;
    }
    ...
    if (formValue.profileUrl.length < 1) {
      error.profileUrl = "Choose one profile pic.";
      isError = true;
    }
    if (formValue.departMentValue.length < 1) {
      error.department = "Oops! You missed your department.";
      isError = true;
    }
    let inputDate = new Date(
      formValue.year,
    ...
    if (inputDate > Date.now()) {
      error.startDate = "Sorry, You moved to future";
      isError = true;
    }
